...
tied to one client.
    ...
    AGENT.md                  identity, transport, the 27 tools
...
## Live endpoints
- MCP:     https://bkjr-mcp.getbijou.xyz/mcp   (27 tools, bearer required)
...
`GET /health` -> `{"status":"ok","tools":27}`, then the 401/401/200 auth check.
